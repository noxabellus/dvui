...
pub fn Parser(comptime Reader: type) type {
    return struct {
        ...
        fn DualTempStorageResult(comptime T1: type, comptime T2: type) type { return struct { first: []T1, second: []T2 }; }
        fn setDualTempStorage(
            ...
            const result = DualTempStorageResult(T1, T2) {
